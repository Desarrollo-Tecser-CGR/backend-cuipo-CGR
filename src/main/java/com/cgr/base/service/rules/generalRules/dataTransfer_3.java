...
public class dataTransfer_3 {
        ...
        public void applyGeneralRule3() {
                ...
                UtilsDB.ensureColumnsExist(TABLA_PROG_INGRESOS, "PRESUPUESTO_INICIAL_TRIMESTRE_03:NVARCHAR(50)",
                                "CA0030_RG_3:NVARCHAR(1)");

                String updateTrimestrePrevioQuery = String.format(
                                """
                                                UPDATE a
                                                SET a.PRESUPUESTO_INICIAL_TRIMESTRE_03 =
                                                    CASE
                ...
                String updateRegla3Query = String.format(
                                """
                                                ...
                                                SET a.CA0030_RG_3 =
                                                    CASE
                                                        WHEN a.PRESUPUESTO_INICIAL = a.PRESUPUESTO_INICIAL_TRIMESTRE_03 THEN 0
                                                        ELSE 1
                                                    END
                                                FROM %s a
                                                """,
