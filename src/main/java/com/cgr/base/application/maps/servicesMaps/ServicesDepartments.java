...
public class ServicesDepartments {
    ...
    public ResponseEntity<Map<String, Object>> searchDepartment(long id) {
        ...
        try {
            ...
            response.put("message", "Error al buscar el departamento por ID: " + e.getMessage());
    ...
    public ResponseEntity<Map<String, Object>> searchDepartmenDp(String id) {
        try {
            Optional<EntityDepartments> searchDepar = repositoryDepartment.findByDpto_ccdgo(id.trim());
      ...
      public ResponseEntity<Map<String, Object>> searchDepartmenDpAll(Long id) {
        try {
            ...
            if (searchDepar.isPresent()) {
                ...
                if (entity.getMunicipalitie() != null && !entity.getMunicipalitie().isEmpty()) {
